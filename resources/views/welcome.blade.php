                ...
                <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
                    ...
                    @else
                        ...
                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="ml-4 text-sm text-gray-700 dark:text-gray-500 underline">สมัครสมาชิก</a>
                        @endif
                    @endauth
                </div>
            @endif
                ...
                <div class="mt-12 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
                    <div class="grid grid-cols-3 md:grid-cols-1">
                        <div class="flex items-center">
                                ...
                                <h1>ชงโคคาร์แคร์วิทยาลัยเทคนิคพังงา</h1>
                        </div>
                    </div>
                </div>
            </div>
